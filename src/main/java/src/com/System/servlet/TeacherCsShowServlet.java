...
@WebServlet(urlPatterns = "/TeacherCsShowServlet")
public class TeacherCsShowServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if("check".equals(method)){
            ...
            List<CourseScheduling> courseSchedulingList =  courseSchedulingDAO.checkCourseSchedulingteach(tnames);
            request.setAttribute("courseSchedulingList",courseSchedulingList);
            request.getRequestDispatcher("TeacherCs.jsp").forward(request,response);
